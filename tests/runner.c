...
/* inherited from the removed ai_command_is_readonly() suite */
...
int main(void) {
    ...
    failed += test_vector_insert_at_zero_into_empty();
    failed += test_vector_insert_at_zero_shifts_existing();
    failed += test_vector_insert_in_middle();
    failed += test_vector_insert_at_size_appends();
    failed += test_vector_insert_past_size_appends();
    failed += test_vector_insert_null_vector_is_noop();
    failed += test_vector_insert_grows_past_initial_capacity();
    ...
    failed += test_str_append_fmt_fits();
    failed += test_str_append_fmt_exactly_fits();
    failed += test_str_append_fmt_does_not_fit_leaves_buf_intact();
    ...
    printf("\n--- Key Encode ---\n");
    failed += test_key_arrows_unmodified_normal();
    failed += test_key_arrows_unmodified_app_mode();
    failed += test_key_arrows_all_modifiers_normal();
    failed += test_key_arrows_all_modifiers_app_mode_same_as_normal();
    failed += test_key_home_end_normal_and_app();
    failed += test_key_home_end_modified();
    failed += test_key_ins_del_pgup_pgdn_unmodified();
    failed += test_key_ins_del_pgup_pgdn_all_modifiers();
    failed += test_key_f1_f4_unmodified();
    failed += test_key_f1_f4_modified();
    failed += test_key_f5_f12_unmodified();
    failed += test_key_f5_f12_all_modifiers();
    failed += test_key_f12_ctrl_shift_literal();
    failed += test_key_f5_ctrl_literal();
    failed += test_key_tab_plain();
    failed += test_key_tab_shift();
    failed += test_key_tab_alt();
    failed += test_key_tab_alt_shift();
    failed += test_key_tab_ctrl_ignored();
    failed += test_key_backspace_ssh();
    failed += test_key_backspace_local();
    failed += test_key_backspace_alt_ssh();
    failed += test_key_backspace_alt_local();
    failed += test_key_backspace_ctrl_shift_ignored();
    failed += test_key_char_plain_printable();
    failed += test_key_char_shift_ignored();
    failed += test_key_ctrl_space();
    failed += test_key_ctrl_letters();
    failed += test_key_ctrl_digit_specials();
    failed += test_key_ctrl_already_control_byte_unchanged();
    failed += test_key_ctrl_equals_and_minus_unchanged();
    failed += test_key_alt_lowercase();
    failed += test_key_alt_uppercase();
    failed += test_key_ctrl_alt_f();
    failed += test_key_none_returns_zero();
    failed += test_key_count_returns_zero();
    failed += test_key_out_of_range_returns_zero();
    failed += test_key_null_out_returns_zero();
    failed += test_key_size_too_small_returns_zero_and_untouched();
    failed += test_key_exact_fit_size_succeeds();
    failed += test_key_unknown_mod_bits_ignored();
    failed += test_key_unknown_flag_bits_ignored();
    ...
    failed += test_config_profile_new_defaults_kind_ssh_shell_empty();
    failed += test_config_profile_kind_missing_defaults_to_ssh();
    failed += test_config_profile_kind_local_allows_empty_host_user_password();
    failed += test_config_profile_shell_roundtrip_with_backslashes_and_spaces();
    failed += test_config_profile_kind_shell_roundtrip_multiple_profiles();
    failed += test_config_ensure_local_profile_inserts_when_absent();
    failed += test_config_ensure_local_profile_second_call_is_noop();
    failed += test_config_ensure_local_profile_noop_when_local_already_first();
    ...
    failed += test_cli_local_alone();
    failed += test_cli_local_with_session_name();
    failed += test_cli_local_with_host();
    failed += test_cli_local_with_no_connect();
    failed += test_cli_local_twice();
    failed += test_cli_local_with_theme_is_error();
    failed += test_cli_local_not_matched_by_prefix();
    failed += test_cli_usage_text_mentions_local();
    ...
    failed += test_cmd_classify_linux_editors_and_chown_write();
    failed += test_cmd_classify_redirect_devnull_spacing_and_ampersand();
    ...
    failed += test_tabmgr_remove_active_reports_reselect();
    failed += test_tabmgr_remove_active_first_selects_next();
    failed += test_tabmgr_remove_before_active_keeps_same_tab();
    failed += test_tabmgr_remove_after_active_no_reselect();
    failed += test_tabmgr_remove_no_survivor_no_reselect();
    ...
    failed += test_shell_prompt_is_continuation_bare_gt();
    failed += test_shell_prompt_is_continuation_bare_gt_trailing_space();
    failed += test_shell_prompt_is_continuation_dquote();
    failed += test_shell_prompt_is_continuation_cmdsubst();
    failed += test_shell_prompt_is_continuation_heredoc();
    failed += test_shell_prompt_is_continuation_then();
    failed += test_shell_prompt_is_continuation_foo_negative();
    failed += test_shell_prompt_is_continuation_router_negative();
    failed += test_shell_prompt_is_continuation_word_prefix_negative();
    failed += test_shell_prompt_is_continuation_dollar_negative();
    failed += test_shell_prompt_is_continuation_empty_negative();
    ...
    failed += test_shell_prompt_is_windows_powershell_user_path();
    failed += test_shell_prompt_is_windows_powershell_drive_root();
    failed += test_shell_prompt_is_windows_powershell_path_with_spaces();
    failed += test_shell_prompt_is_windows_pwsh_on_unix_path();
    failed += test_shell_prompt_is_windows_powershell_remoting_prefix();
    failed += test_shell_prompt_is_windows_powershell_remoting_prefix_fqdn();
    failed += test_shell_prompt_is_windows_cmd_bare();
    failed += test_shell_prompt_is_windows_cmd_drive_root();
    failed += test_shell_prompt_is_windows_cmd_customized_space_before_terminator();
    failed += test_shell_prompt_is_windows_typed_redirect_still_matches();
    failed += test_shell_prompt_is_windows_bash_negative();
    failed += test_shell_prompt_is_windows_bash_space_before_terminator_negative();
    failed += test_shell_prompt_is_windows_zsh_negative();
    failed += test_shell_prompt_is_windows_cisco_negative();
    failed += test_shell_prompt_is_windows_comware_negative();
    failed += test_shell_prompt_is_windows_mikrotik_negative();
    failed += test_shell_prompt_is_windows_arubaos_negative();
    ...
    failed += test_dispatch_line_clear_ssh_windows_prompt_overrides_to_none();
    failed += test_dispatch_line_clear_local_readline_shell_windows_prompt_overrides_to_none();
    failed += test_dispatch_line_clear_local_none_shell_windows_prompt_stays_none();
    failed += test_dispatch_line_clear_windows_prompt_false_is_unchanged();
    ...
    failed += test_term_at_prompt_sparse_after_resize_shrink();
    failed += test_term_at_prompt_sparse_after_resize_shrink_row1();
    failed += test_term_at_prompt_fresh_terminal_not_sparse();
    ...
    failed += test_term_cursor_row_is_windows_prompt_powershell();
    failed += test_term_cursor_row_is_windows_prompt_cmd();
    failed += test_term_cursor_row_is_windows_prompt_bash_negative();
    failed += test_term_cursor_row_is_windows_prompt_alt_screen_active();
    ...
    failed += test_vt_el1_at_deferred_wrap_no_oob();
    failed += test_vt_ed1_at_deferred_wrap_no_oob();
    failed += test_vt_csi_digit_saturates_at_65535();
    failed += test_vt_ich_int_max_param_no_crash();
    failed += test_vt_il_11_digit_param_no_crash();
    failed += test_vt_scroll_up_region_beyond_64_moves_marker();
    failed += test_vt_scroll_down_region_beyond_64_moves_marker();
    failed += test_vt_il_beyond_64_moves_marker();
    failed += test_vt_dl_beyond_64_moves_marker();
    ...
    failed += test_ai_extract_commands_ex_embedded_newline_rejected();
    ...
    failed += test_ai_extract_commands_ex_null_rejected_ok();
    failed += test_ai_extract_commands_ex_oversized_block_skipped_others_intact();
    failed += test_ai_extract_commands_ex_oversized_with_newline_counts_as_long_only();
    failed += test_ai_extract_commands_ex_exactly_1023_bytes_accepted();
    failed += test_ai_extract_commands_ex_1024_bytes_skipped();
    failed += test_ai_extract_commands_ex_rejected_counters_independent();
    failed += test_ai_extract_commands_ex_both_out_params_null_safe();
    failed += test_ai_continue_text_empty_queue_same_as_null();
    failed += test_ai_continue_text_lists_batch_outcomes_and_elides_long_command();
    failed += test_ai_continue_text_executing_outcome_named();
    failed += test_ai_continue_text_blocked_and_pending_outcomes_named();
    failed += test_ai_continue_text_queue_overflow_returns_zero();
    failed += test_ai_continue_text_stopped_batch_opening();
    failed += test_ai_continue_text_completed_batch_opening_unchanged();
    failed += test_ai_continue_text_elide_utf8_char_boundary();
    ...
    failed += test_extract_last_n_sparse_after_resize_shrink();
    ...
    failed += test_dock_terminal_grid_normal();
    failed += test_dock_terminal_grid_with_panel();
    failed += test_dock_terminal_grid_iconic_leaves_grid_alone();
    failed += test_dock_terminal_grid_no_font_metrics();
    failed += test_dock_terminal_grid_tiny_visible_clamps_to_one();
    ...
    failed += test_sel_extract_sparse_after_resize_shrink();
    ...
    failed += test_chat_cmd_label_blocked_is_held();
    failed += test_chat_cmd_label_denied();
    failed += test_chat_cmd_label_skipped();
    failed += test_chat_cmd_label_queued();
    failed += test_chat_cmd_label_running();
    failed += test_chat_cmd_label_done();
    failed += test_chat_cmd_label_aborted();
    failed += test_chat_cmd_label_unexpected_run_falls_back_to_queued();
    failed += test_chat_cmd_label_null_intent_ok();
    failed += test_chat_msg_batch_sync_run_basic();
    failed += test_chat_msg_batch_sync_run_batch_ending();
    failed += test_chat_msg_batch_sync_run_settled_items_still_synced();
    failed += test_chat_msg_batch_sync_run_unrelated_batch_untouched();
    failed += test_chat_msg_batch_sync_run_null_list_returns_zero();
    failed += test_chat_msg_batch_sync_run_null_queue_returns_zero();
    failed += test_chat_msg_batch_sync_run_empty_queue_leaves_items_untouched();
    ...
    failed += test_cmd_selected_default_checked();
    failed += test_cmd_selected_default_unchecked_when_held();
    ...
    failed += test_approval_card_layout_header_above_rows();
    ...
    failed += test_approval_card_layout_run_enabled_truth_table();
    failed += test_approval_card_layout_held_row_flag();
    ...
    failed += test_ai_panel_layout_tiles_exact_sum_192();
    ...
    failed += test_thinking_wheel_over_box_cursor_inside_overflowing_box();
    failed += test_thinking_wheel_over_box_content_shorter_than_box_no_overflow();
    failed += test_thinking_wheel_over_box_cursor_outside_body_rect();
    failed += test_thinking_wheel_over_box_cursor_at_edges_is_inclusive_low_exclusive_high();
    failed += test_thinking_wheel_over_box_partially_visible_at_bottom_still_hits_visible_part();
    failed += test_thinking_wheel_over_box_partially_visible_above_top_still_hits_visible_part();
    failed += test_thinking_wheel_over_box_taller_than_viewport_50_lines();
    failed += test_thinking_wheel_over_box_collapsed_zero_size_never_hits();
    failed += test_thinking_wheel_should_chain_scrolling_down_mid_content_stays_in_box();
    failed += test_thinking_wheel_should_chain_scrolling_up_mid_content_stays_in_box();
    failed += test_thinking_wheel_should_chain_down_at_bottom_chains();
    failed += test_thinking_wheel_should_chain_up_at_top_chains();
    failed += test_thinking_wheel_should_chain_down_not_yet_at_bottom_stays();
    failed += test_thinking_wheel_should_chain_up_not_yet_at_top_stays();
    failed += test_thinking_wheel_should_chain_no_overflow_always_chains();
    failed += test_thinking_wheel_should_chain_streaming_auto_follow_at_max_chains_down();
    failed += test_thinking_wheel_scroll_down_notch_moves_forward();
    failed += test_thinking_wheel_scroll_up_notch_moves_backward();
    failed += test_thinking_wheel_scroll_clamps_to_zero();
    failed += test_thinking_wheel_scroll_overshoot_clamps_to_max();
    failed += test_thinking_wheel_scroll_exactly_at_bottom_stays_at_max();
    failed += test_thinking_wheel_scroll_negative_max_scroll_clamps_to_zero();
    failed += test_thinking_wheel_scroll_touchpad_fractional_delta_rounds_to_no_movement();
    failed += test_ai_panel_state_titles_actions_and_suggestions_flag();
    failed += test_ai_panel_state_null_for_bad_id();
    failed += test_ai_panel_state_body_empty_substitutes_thousands();
    failed += test_ai_panel_state_body_other_states_ignore_context_lines();
    failed += test_ai_panel_suggestions_exactly_three_nonempty();
    ...
    printf("\n--- Design System: demo ---\n");
    failed += test_ui_demo_states_list_ends_in_all();
    failed += test_ui_demo_build_local_swaps_terminal_text_only();
    failed += test_pty_ring_init_free();
    failed += test_pty_ring_init_explicit_small_cap();
    failed += test_pty_ring_double_free();
    failed += test_pty_ring_null_safety();
    failed += test_pty_ring_push_drain_roundtrip();
    failed += test_pty_ring_push_wraps_buffer_end();
    failed += test_pty_ring_fill_exactly_to_cap();
    failed += test_pty_ring_overflow_sets_full_and_keeps_prefix();
    failed += test_pty_ring_push_zero_len_and_null_data();
    failed += test_pty_ring_drain_partial_and_empty();
    failed += test_pty_ring_interleaved_push_drain_pattern();
    failed += test_pty_ring_eof_flag();
    failed += test_pty_ring_reset_clears_flags_free_zeroes_all();
    failed += test_pty_ring_available_space_invariant();
    failed += test_local_shell_custom_wins_over_everything();
    failed += test_local_shell_custom_command_is_verbatim_not_requoted();
    ...
    failed += test_local_shell_env_nutshell_equals_app_version();
    failed += test_local_shell_env_path_prepends_dir_keeps_parent();
    failed += test_local_shell_env_path_absent_when_parent_unavailable();
    ...
    failed += test_local_shell_quote_no_space();
    failed += test_local_shell_quote_with_space();
    failed += test_local_shell_quote_with_tab();
    failed += test_local_shell_quote_overflow();
    failed += test_local_shell_quote_null_safety();
    failed += test_local_shell_resolve_null_out_is_safe();
    failed += test_local_shell_resolve_null_probe_is_safe();
    ...
    failed += test_ui_demo_executing_rebuild_carries_run_states();
